...
public class BarChartManager {
    ...
    public void showBarChart(List<String> xAxisValues, List<Float> yAxisValues, String label, int color) {
        ...
        mBarChart.getXAxis().setValueFormatter(new StringAxisValueFormatter(xAxisValues));
        ...
        barDataSet.setFormSize(6.f);
        mBarChart.getLegend().setPosition(Legend.LegendPosition.ABOVE_CHART_CENTER);

        ArrayList<IBarDataSet> dataSets = new ArrayList<>();
        dataSets.add(barDataSet);
        BarData data = new BarData(dataSets);
        data.setBarWidth(0.5f);//设置柱状图宽度
        //设置X轴的刻度数
    ...
    public void showBarChart(List<String> xValues, List<Float> yValuesList, List<String> labels){
        ...
        for (int i = 0; i < yValuesList.size(); i++) {
            ...
            barDataSet.setValueTextColor(colors.get(1));
            barDataSet.setValueTextSize(10f);
            data.addDataSet(barDataSet);
        }

...
import com.jinganweigu.RoadWayFire.EZUIkitLoading.LoadingTextView;
import com.jinganweigu.RoadWayFire.Entries.RealPlaySquareInfo;
...
import com.jinganweigu.RoadWayFire.ToolsUtils.EZUIkitUtils.DataManager;
...
import com.jinganweigu.RoadWayFire.ToolsUtils.widget.VerifyCodeInput;
import com.jinganweigu.RoadWayFire.ToolsUtils.widget.WaitDialog;
   ...
   private void  exit(){
    ...
    public void finish() {
        if (mCameraInfo != null){
            ...
            setResult(VideoFragment.RESULT_CODE, intent);
        }
        super.finish();
    }

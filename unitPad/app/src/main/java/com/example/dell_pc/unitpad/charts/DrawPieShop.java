 ...
 */
public class DrawPieShop {
    private Context context;
    private boolean isDetail;
    public void draw(PieChart pie, Context context, int arg1, int arg2, boolean isDetail) {
        this.context = context;
        this.isDetail = isDetail;
        PieData mPieData = getPieData(2, 100, arg1,arg2);
    ...
    private PieData getPieData(int count, float range, int arg1, int arg2) {
        ArrayList<String> xValues = new ArrayList<String>(); //用来表示每个饼块上的内容
        String[] content = new String[]{"已检查", "未检查"};
        ...
        //饼图颜色
        colors.add(0X66FFFFFF);
        colors.add(0X99FFFFFF);
        ...
        pieDataSet.setValueFormatter(new ValueFormatter() {
            ...
            public String getFormattedValue(float v, Entry entry, int i, ViewPortHandler viewPortHandler) {
                String str = String.valueOf((int) v) + "家";
                return str;
            }
        });
        return pieData;

...
public class Electric extends Activity implements View.OnClickListener {
    ...
    private String maxValue, referValue;
    ...
    private String description = "24小时电流曲线（A）";
    private String facTypeID = "";
    private String fac, position, statue, time, value;

    private WebView webView;
    private String URL_ELECTRIC_CHART = "http://jn.xiaofang365.cn/xfwlw/xfwlw/electricChart.php";
...
//        drawPieLevel.draw(pieWaterLevel, this, MainActivity.waterLevelNormalList.size(), MainActivity.waterLevelAbnormalList.size(), MainActivity.waterLevelOfflineList.size());
    ...
    private void initData() {
        ...
        maxValue = intent.getStringExtra("maxValue");
        referValue = intent.getStringExtra("standardValue");;


        URL_ELECTRIC_CHART = URL_ELECTRIC_CHART + "?value=" + value + "&maxValue=" + maxValue + "&referValue=" + referValue;
    }
    ...
    private void initView() {
        ...
        facAdapter = new FacAdapter(Electric.this, MainActivity.waterPressList);
        lv.setAdapter(facAdapter);
        facAdapter.notifyDataSetChanged();

        webView = (WebView) findViewById(R.id.wvWaterPress);
        webView.loadUrl(URL_ELECTRIC_CHART);
        ...
        if (statue.equals("normal")) {
            tvStatue.setText("电流正常");
        } else if (statue.equals("alarm")) {
            tvStatue.setText("电流过高");
        } else {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (facTypeID.equals("1")) {
                        ...
                        yValueRefer.add(new Entry(Float.valueOf(referValue), i));
                    }

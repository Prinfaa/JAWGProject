...
import com.example.dell.unittv.tools.NetStatue;
    ...
    class GetLogInfo extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
                    ...
                    try {
                        ...
                        while ((line = reader.readLine()) != null) {
                            ...
                            companyID = object.getString("unitID");
                            companyName = object.getString("unitName");
                        }
        ...
        protected void onPostExecute(String file_url) {
            ...
            if(Info.equals("success")){
                ...
                textViewInfo.setText("欢迎您进入FIS智慧消防服务平台");

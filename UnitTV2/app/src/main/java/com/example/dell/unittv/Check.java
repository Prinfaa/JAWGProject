...
import com.example.dell.unittv.adapter.CheckAbnormalAdapter;
import com.example.dell.unittv.adapter.CheckNormalAdapter;
import com.example.dell.unittv.adapter.UnCheckAdapter;
import com.example.dell.unittv.charts.DrawBarCheck;
    ...
    public void onClick(View v) {
        if (v == tvAbnormalFacTitle) {
            if (llCheckNormal.getVisibility() == View.VISIBLE) {
                ...
                tvAbnormalFacTitle.setTextColor(0XFFFFFFFF);
                tvNormalFacTitle.setTextColor(0XFF88CFFF);
            ...
            if (llCheckAbnormal.getVisibility() == View.VISIBLE) {
                ...
                tvAbnormalFacTitle.setTextColor(0XFF88CFFF);
                tvNormalFacTitle.setTextColor(0XFFFFFFFF);
            }
        }
    }
}

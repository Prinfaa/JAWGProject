...
public class CheckNormalAdapter extends BaseAdapter {

    private Context context;
    private List<CheckedItem> checkedList;


    public CheckNormalAdapter(Context context, List<CheckedItem> checkedList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = LayoutInflater.from(context).inflate(R.layout.check_normal_item,null);
        }
        ...
        if(!checkedItem.getProblemID().equals("")){
            ...
            strStatue = "正常";
            tvStatue.setTextColor(0xFFFFFFFF);
        }

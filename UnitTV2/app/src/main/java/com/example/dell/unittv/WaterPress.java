...
import com.example.dell.unittv.charts.LineChartManager;
...
public class WaterPress extends Activity implements View.OnClickListener {
    ...
    private String URL_WATER_PRESS_PLAN = "http://jn.xiaofang365.cn/xfwlw/xfwlw/waterPressPlan_tv.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.water_press);
...
//        drawPieLevel.draw(pieWaterLevel, this, MainActivity.waterLevelNormalList.size(), MainActivity.waterLevelAbnormalList.size(), MainActivity.waterLevelOfflineList.size());
    ...
    private void initData() {
        ...
        URL_WATER_PRESS_PLAN = URL_WATER_PRESS_PLAN + "?value=" + value + "&fac=" + facTypeID;
    }
    ...
    private void initView() {
        ...
        facAdapter = new FacAdapter(WaterPress.this, MainActivity.waterPressList);
        lv.setAdapter(facAdapter);
        facAdapter.notifyDataSetChanged();

        webView = (WebView) findViewById(R.id.wvWaterPress);
        webView.loadUrl(URL_WATER_PRESS_PLAN);
        ...
        tvIntroduce.setText("\u3000\u3000室外低压给水管道的水压，当生活、生产和消防用水量达最大时，不应小于0.1MPa。\n\n" +
                "\u3000\u3000当建筑高度不超过100米时，高层建筑最大不利点消火栓静水压力不应低于0.07MPa；\n\n" +
                "\u3000\u3000当建筑高度超过100米时，高层建筑最大不利点消火栓静水压力不应低于0.15MPa；");

        tvFac.setText(fac);
        tvPosition.setText(position);
        if (statue.equals("normal")) {
            tvStatue.setText("水压正常");
        } else if (statue.equals("alarm")) {
            tvStatue.setText("水压不足");
        } else {

...
public class ReadyEnterDeviceBean {


    /**
     * code : 200
     * msg : 操作成功，请求成功!
     * result : {"rtu_id":"222222222222222","rtu_type":"4","mitu_type":"水压水位监测","in_mitu_peo":"测试1","warehouse_id":"1","warehouse_name":"经安纬固仓库"}
     */

package com.jinganweigu.entrysystem.service;
...
import com.jinganweigu.entrysystem.utils.IOUtils;
import com.jinganweigu.entrysystem.utils.InstallUtil;
import com.jinganweigu.entrysystem.utils.SystemManager;
...
public class DownloadService extends Service {
    ...
    public class DownloadBinder extends Binder{
        ...
        public long startDownload(String apkUrl){
            //点击下载
            //删除原有的APK
            IOUtils.clearApk(DownloadService.this,"OutGoingSystem.apk");
            //使用DownLoadManager来下载
            DownloadManager.Request request = new DownloadManager.Request(Uri.parse(apkUrl));
            //将文件下载到自己的Download文件夹下,必须是External的
            //这是DownloadManager的限制
            File file = new File(getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "OutGoingSystem.apk");
    ...
    private class DownloadFinishReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!apkPath.isEmpty()){
                ...
                InstallUtil util=new InstallUtil();

                util.install(context,apkPath,mIsRoot);
            }else {

...
public class WellCome extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Timer().schedule(new TimerTask() {
            @Override
            public void run() {
                startActivity(new Intent(WellCome.this, Chose.class));

//                Intent intent=new Intent(WellCome.this,WebWaterActivity.class);
//
//                intent.putExtra("link","http://dndzl.cn/display/src/main/webapp/web/hydrant.html");
//

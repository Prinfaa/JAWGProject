...
public class AllShopProblemNotDealAdapter extends BaseAdapter {

    private Context context;
    private List<ShopProblemNotDealItem> shopProblemNotDealList;

    public AllShopProblemNotDealAdapter(Context context, List<ShopProblemNotDealItem> shopProblemNotDealList) {

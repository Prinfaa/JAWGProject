 ...
 */
public class ChartStudy extends Activity implements View.OnClickListener {
    private final static String TAG = ChartStudy.class.getSimpleName();
...
//    }
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chart_study);
...
//        chartLyt = (LinearLayout) findViewById(R.id.chart);
        //mTf = Typeface.createFromAsset(getAssets(), "fonts/OpenSans-Semibold.ttf");
